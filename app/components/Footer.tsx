    ...
    <div className="relative mt-8">
      <div className="absolute bottom-full w-full flex justify-center image-rendering-pixelated">
        <div 
          ...
          style={{ 
            backgroundImage: `url(${isDark ? '/wood_table_dark.png' : '/wood_table.png'})`,
            ...
            <div className="flex flex-wrap items-center">
              <div className="w-full md:flex-1 flex items-center justify-center gap-4">
                {links.map(link => (
                  ...
                  >
                    <Image
                      src={link.isHovered ? `/icon_${link.key}_hover.png` : `/icon_${link.key}_footer.png`}
                      width={link.iconSize}
                      ...
                      unoptimized
                    />
                    <span className={`footer-link ${link.isHovered ? 'text-[#bf7958]' : 'text-[#a05b53]'}`}>
                      {link.label}
                    </span>
                  </a>
                ))}
              ...
              <div className="w-full md:w-auto flex justify-center md:justify-end mt-2 md:mt-0 md:absolute md:right-4">
                ...
                >
                  <Image
                    src={isPixelsByComicHovered ? "/pixelsbycomic_hover.png" : "/pixelsbycomic.png"}
                    width={43 * 2}
                    height={14 * 2}
                    alt=""
                    className="image-rendering-pixelated"
