...
export default function Order() {
  ...
  const TearEdge = ({ isTop = false }: { isTop?: boolean }) => (
    <div className={`absolute ${isTop ? '-top-[7px] rotate-180' : 'lg:-bottom-[7px] bottom-[9px]'} left-0 right-0`}>
      <Image
        ...
        <div className="flex flex-col relative z-[1]">
          <div className="mb-4 flex justify-between items-center pixel-text">
            <div>
              ...
              <p className="mb-2">
                Frog Soup is the first project in the <strong>TOAD KILLER</strong> ecosystem.
              </p>
              <p className="mb-2">
                It is a collection of <span data-numbers>5029</span> delicious meals, prepared lovingly by The Chefs.
              </p>
              ...
              <span className="text-center">
                <p className="text-3xl mt-1 font-bold">
                  <span data-numbers>33</span>% <span className="relative inline-block fire-text">
              ...
              <p className="text-2xl mb-2 mt-1 font-bold flex justify-center gap-6 w-full text-[#a0938e]">
                <span><span data-numbers>33</span>% DEV</span>
                <span>|</span>
                <span><span data-numbers>33</span>% ART</span>
              </p>
              
              <hr className="border-t border-black/20 my-4" />
              
              <p className="mb-4">
                <strong>Hungry yet?</strong> You can place your order by selecting an option from the menu{' '}
              ...
              <div className="flex justify-center gap-8 mt-8 w-full">
                {socialLinks.map(link => (
                  ...
                  >
                    <Image
                      src={link.isHovered ? `icon_${link.key}_hover.png` : `icon_${link.key}.png`}
                      width={link.size * 3}
                      height={link.size * 3}
                      alt={link.alt}
                      className="image-rendering-pixelated"
